...
class Connection
{
    ...
    public static function fromDsn(string $dsn, array $redisOptions = [], $redis = null): self
    {
        ...
        if (\array_key_exists('delete_after_ack', $redisOptions)) {
            ...
            trigger_deprecation('symfony/redis-messenger', '5.4', 'Not setting the "delete_after_ack" boolean option explicitly when using the redis transport is deprecated, its default value will change to true in 6.0.');
        }
